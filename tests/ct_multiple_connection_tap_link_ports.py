...
class Connection_Track(BaseTest):
    ...
    def runTest(self):
        ...
        log.info("Verification of data traffic after connection closing for TAP0 and Link Port")
        log.info("----------------------------------------------------------------------------")
        log.info("Sending data packet: A->B")
        ...
        log.info("Verification of data traffic after connection closing for TAP1 and TAP2 Port")
        log.info("----------------------------------------------------------------------------")
        log.info("Sending data packet: A->B")
