...
class Connection_Track(BaseTest):
    ...
    def runTest(self):
        ...
        pkt = simple_udp_packet(eth_src=self.config_data['traffic']['in_pkt_header']['eth_mac'][0], eth_dst=self.config_data['traffic']['in_pkt_header']['eth_mac'][1], ip_src=self.config_data['traffic']['in_pkt_header']['ip_address'][0] , ip_dst=self.config_data['traffic']['in_pkt_header']['ip_address'][1], udp_sport=self.config_data['traffic']['in_pkt_header']['udp_port'][0], udp_dport=self.config_data['traffic']['in_pkt_header']['udp_port'][1])
        ...
        pkt = simple_udp_packet(eth_src=self.config_data['traffic']['in_pkt_header']['eth_mac'][1], eth_dst=self.config_data['traffic']['in_pkt_header']['eth_mac'][0], ip_src=self.config_data['traffic']['in_pkt_header']['ip_address'][1] , ip_dst=self.config_data['traffic']['in_pkt_header']['ip_address'][0], udp_sport=self.config_data['traffic']['in_pkt_header']['udp_port'][1], udp_dport=self.config_data['traffic']['in_pkt_header']['udp_port'][0])
        ...
        try:
            ...
            self.result.addFailure(self, sys.exc_info())
            log.failed(f" Verification of udp packet B->A sent failed with exception {err}")
